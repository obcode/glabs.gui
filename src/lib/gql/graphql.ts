...
export type CourseRepoOverviewQueryVariables = Exact<{
  course: string;
}>;


export type CourseRepoOverviewQuery = { courseRepoOverview: Array<{ name: string, per: string, targets: number, existing: number, note: string | null, repos: Array<{ for: string, url: string, exists: boolean }> }> };
...
export type CourseStudentsQuery = { courseStudents: Array<{ email: string, found: boolean, firstName: string | null, lastName: string | null, gender: string | null, group: string | null, mtknr: string | null }> };
